...
// // ANSWER: 0(1) No, we cannot rewrite it because it is already constant time. 
...
// // separate numbers using split method .split("") which will return an array that we save to a variable
// // for loop to square each number in the array
// // join method .join("")
// parseInt after join method to turn it into a number
